...
//         <div class="card bg-secondary mt-4 text-center">
//             <h4 class="text-white p-3 pt-2 pb-2">To Do App</h4>
//         </div>
//         <hr>


//         <input type="text" class="form-control" placeholder="Items " [(ngModel)]="addTaskValue">
//         <br>
...
//         <h4 class="text-primary mt-4">List : </h4>

//         <div style="overflow-y: auto; height: 350px;">
//             <div class="m-3" *ngFor="let task of taskArr">
//                 <div class="p-2 shadow border" id="tasks">
//                     <div class="input-group row ps-3">
//                         <div class="card col-md-10 border-0"> {{task.description}}</div>
//                         <button class="btn btn-outline-primary col me-2"  type="button">e</button>
